...
LABEL_KEYWORDS = {
    ...
    "Pull-Up": ["pullup", "pull-up", "pull ups", "chin up", "chin-up", "strict pullup", "pullup form"],
...
def search_and_save(base_keywords, output_csv="youtube_scraped.csv", results_per_query=5):
    all_entries = []
